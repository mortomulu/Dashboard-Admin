...
<?php }?>
  ...
  <div class="card-body">
    <div class="form-group row">
      <label for="kategori_blog" class="col-sm-3 col-form-label">
      Kategori Blog</label>
      <div class="col-sm-7">
          <input type="text" class="form-control" id="kategori_blog"
          name="kategori_blog" value="<?php echo $kategori_blog;?>">
      </div>
    </div>
  </div>
  <!-- /.card-body -->
